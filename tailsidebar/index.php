...
<body class="bg-blue-600 font-[Poppins]">
    <span class="absolute text-white text-4x1 top-5 left-4 cursor-pointer" onclick="Openbar()">
        <i class="bi bi-filter-left px-2 bg-gray-900 rounded-md"></i>
    </span>
<div class="container">  
    <div class="sidebar fixed top-0 bottom-0 lg:left-0 left-[-300px] duration-1000
    p-2 w-[300px] overflow-y-quto text-center bg-gray-900 shadow h-screen">

        <div class="text-gray-100 text-xl container">
    ...
    <div class="main">
        <div class="pl-96 py-8 w-full relative">
                ...
                <table class="min-w-full bg-white">
                    <thead class="bg-gray-800 text-white">
                        <tr>
                            ...
                            <th class="w-1/4 text-left py-3 px-4 uppercase font-semibold text-sm">To</th>
                            <th class="w-1/4 text-left py-3 px-4 uppercase font-semibold text-sm">Date to Depart</th>
                            <th class="w-1/3 text-left py-3 px-4 uppercase font-semibold text-sm">Airline</th>
                        </tr>
                    </thead>
                    <?php 
                    include("db_conn.php");
                    ...
                    <tbody class="text-gray-700">
                        <tr class="bg-white border-b transition duration-300 ease-in-out hover:bg-gray-100">
                            <td class="w-1/4 text-left text-sm py-3 px-4"><?php echo $row['id']?></td>
                            <td class="w-1/4 text-left text-sm py-3 px-4"><?php echo $row['from_place']?></td>
                            <td class="w-1/4 text-left text-sm py-3 px-4"><?php echo $row['to_place']?></td>
                            <td class="w-1/4 text-left text-sm py-3 px-4"><?php echo $row['date']?></td>
                            <td class="w-1/4 text-left text-sm py-3 px-4"><?php echo $row['plane']?></td>
                        </tr>
                    </tbody>
                    <?php }?>
                </table>
